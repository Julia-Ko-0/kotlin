...
//    }
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_blank2_1, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val itemsList = view.findViewById<RecyclerView>(R.id.itemList_Izbr2)
...
//        Log.d("MyLog7",items_manga.toString())
    ...
    private fun getMangLike(): ArrayList<userMangas> {
        ...
        for (i in 0 until userMangasList.count()) {
            if(userMangasList[i].status == "Читаю" ){
                val it = userMangas(
                    username,
                    userMangasList[i].id,
